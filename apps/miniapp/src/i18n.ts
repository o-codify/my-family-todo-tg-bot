...
const DICT: Record<string, Record<Locale, string>> = {
  ...
  'common.copyFailed.short': { ru: 'Не получилось', en: 'Failed' },
  'common.save': { ru: 'Сохранить', en: 'Save' },
  'catalog.edit.title': { ru: 'Изменить товар', en: 'Edit item' },
  'catalog.edit.emoji': { ru: 'Иконка', en: 'Icon' },
  'catalog.edit.category': { ru: 'Категория', en: 'Category' },
  'catalog.edit.category.none': { ru: '— без категории —', en: '— uncategorised —' },
  ...
  'history.type.changes': { ru: 'Изменения', en: 'Changes' },
  'history.change.task.create': { ru: 'Создана задача', en: 'Created task' },
  'history.change.task.update': { ru: 'Изменена задача', en: 'Updated task' },
  'history.change.task.delete': { ru: 'Удалена задача', en: 'Deleted task' },
  'history.change.task.restore': { ru: 'Восстановлена задача', en: 'Restored task' },
  'history.change.unknownEntity': { ru: '—', en: '—' },
  'history.change.fields': { ru: 'Поля', en: 'Fields' },
  'history.change.field.title': { ru: 'название', en: 'title' },
  'history.change.field.description': { ru: 'описание', en: 'description' },
  'history.change.field.type': { ru: 'тип', en: 'type' },
  'history.change.field.schedule': { ru: 'расписание', en: 'schedule' },
  'history.change.field.assigneeId': { ru: 'ответственный', en: 'assignee' },
  'history.change.field.queueUserIds': { ru: 'участники очереди', en: 'queue members' },
  'history.change.field.participantIds': { ru: 'участники', en: 'participants' },
  'history.change.field.deadlineAt': { ru: 'дедлайн', en: 'deadline' },
  'history.change.field.points': { ru: 'награда', en: 'reward' },
  'history.change.field.photoRequired': { ru: 'фото', en: 'photo' },
  'history.change.field.requiresApproval': { ru: 'одобрение', en: 'approval' },
  'history.change.field.isQuest': { ru: 'квест', en: 'quest' },
  'history.change.field.singleShot': { ru: 'однократно', en: 'one-shot' },
  'history.change.field.cooldownDays': { ru: 'кулдаун', en: 'cooldown' },
  ...
  'create.tags.title': { ru: 'Теги', en: 'Tags' },
  'create.tags.add': { ru: 'Новый тег', en: 'New tag' },
  'create.tags.namePrompt': { ru: 'Название тега', en: 'Tag name' },
  'create.field.time': { ru: 'Время', en: 'Time' },
  'create.time.any': { ru: 'В любое время', en: 'Any time' },
  ...
  'shopping.index.empty.title': { ru: 'Нет списков', en: 'No lists yet' },
  'shopping.index.empty.hint': {
    ru: 'Создай первый список — кнопка справа сверху',
    en: 'Create your first list — button top-right',
  },
  'shopping.list.create': { ru: 'Список', en: 'List' },
  'shopping.list.edit': { ru: 'Изменить список', en: 'Edit list' },
  'shopping.list.archive': { ru: 'Архивировать список', en: 'Archive list' },
  'shopping.list.unassigned': { ru: 'Не назначено', en: 'Unassigned' },
  'shopping.field.name': { ru: 'Название', en: 'Name' },
  'shopping.field.assignee': { ru: 'Ответственный', en: 'Assignee' },
  'shopping.field.dueDate': { ru: 'Срок', en: 'Due date' },
  'shopping.fromCatalog': { ru: 'Из каталога', en: 'From catalog' },
  'shopping.catalogPicker.title': {
    ru: 'Добавить из каталога',
    en: 'Add from catalog',
  },
  'shopping.catalogPicker.search': { ru: 'Поиск…', en: 'Search…' },
  'shopping.catalogPicker.empty': { ru: 'Каталог пуст', en: 'Catalog is empty' },
  'shopping.catalogPicker.add': { ru: 'Добавить', en: 'Add' },
  'shopping.moveTo.title': { ru: 'Переместить в…', en: 'Move to…' },
  'shopping.moveTo.noOthers': {
    ru: 'Других списков нет',
    en: 'No other lists',
  },
  'shopping.moveTo.newList': { ru: 'Новый список', en: 'New list' },
  'shopping.added': { ru: 'добавлено', en: 'added' },
  'shopping.skipped': { ru: 'пропущено', en: 'skipped' },
  'shopping.empty.hint': {
  ...
  'events.empty.title': { ru: 'Пока пусто', en: 'No dates yet' },
  'events.empty.hint': {
    ru: 'Добавь день рождения близкого — мы напомним заранее',
    en: 'Add a birthday — we’ll remind you ahead of time',
  },
  'events.add': { ru: 'Добавить дату', en: 'Add date' },
  'events.section.upcoming': { ru: 'Скоро', en: 'Upcoming' },
  'events.section.thisWeek': { ru: 'На этой неделе', en: 'This week' },
  'events.section.thisMonth': { ru: 'В этом месяце', en: 'This month' },
  'events.section.later': { ru: 'Позже', en: 'Later' },
  'events.today': { ru: 'Сегодня!', en: 'Today!' },
  'events.tomorrow': { ru: 'Завтра', en: 'Tomorrow' },
  'events.inNDays': { ru: 'через {n} дн.', en: 'in {n}d' },
  'events.turns': { ru: 'исполняется', en: 'turns' },
  'events.type.birthday': { ru: 'День рождения', en: 'Birthday' },
  'events.type.anniversary': { ru: 'Годовщина', en: 'Anniversary' },
  'events.type.nameday': { ru: 'Именины', en: 'Name day' },
  'events.type.memorial': { ru: 'Памятная дата', en: 'Memorial' },
  'events.type.custom': { ru: 'Дата', en: 'Date' },
  'events.field.title': { ru: 'Название', en: 'Title' },
  'events.field.type': { ru: 'Тип', en: 'Type' },
  'events.field.emoji': { ru: 'Эмодзи', en: 'Emoji' },
  'events.field.month': { ru: 'Месяц', en: 'Month' },
  'events.field.day': { ru: 'День', en: 'Day' },
  'events.field.year': { ru: 'Год (для возраста)', en: 'Year (for age)' },
  'events.field.member': { ru: 'Член семьи', en: 'Family member' },
  'events.field.member.none': { ru: 'Не связано', en: 'Not linked' },
  'events.field.notify': { ru: 'Напомнить за', en: 'Remind' },
  'events.notify.0': { ru: 'в день', en: 'on the day' },
  'events.notify.1': { ru: 'за 1 день', en: '1 day before' },
  'events.notify.3': { ru: 'за 3 дня', en: '3 days before' },
  'events.notify.7': { ru: 'за неделю', en: '1 week before' },
  'events.notify.30': { ru: 'за месяц', en: '1 month before' },
  'events.save': { ru: 'Сохранить', en: 'Save' },
  'events.cancel': { ru: 'Отмена', en: 'Cancel' },
  'events.delete': { ru: 'Удалить', en: 'Delete' },
  'events.month.1': { ru: 'Январь', en: 'January' },
  'events.month.2': { ru: 'Февраль', en: 'February' },
  'events.month.3': { ru: 'Март', en: 'March' },
  'events.month.4': { ru: 'Апрель', en: 'April' },
  'events.month.5': { ru: 'Май', en: 'May' },
  'events.month.6': { ru: 'Июнь', en: 'June' },
  'events.month.7': { ru: 'Июль', en: 'July' },
  'events.month.8': { ru: 'Август', en: 'August' },
  'events.month.9': { ru: 'Сентябрь', en: 'September' },
  'events.month.10': { ru: 'Октябрь', en: 'October' },
  'events.month.11': { ru: 'Ноябрь', en: 'November' },
  'events.month.12': { ru: 'Декабрь', en: 'December' },
  ...
  'shop.rewards.tasksUntil': { ru: 'задач', en: 'tasks' },
  'shop.sort.cost': { ru: 'По цене', en: 'By cost' },
  'shop.sort.closest': { ru: 'Ближайшие', en: 'Closest' },
